...
try: 
    ...
    # input4 = browser.find_element(By.CLASS_NAME, "first_class")
    # input4.send_keys("+375252352569")
    # input5 = browser.find_element(By.CLASS_NAME, "second_class")
    # input5.send_keys("St.Belaya 5")
